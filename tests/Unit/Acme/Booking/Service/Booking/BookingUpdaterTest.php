 ...
 */
class BookingUpdaterTest extends TestCase
{
    public function testSuccess(): void
    {
        ...
        $booking = Booking::create($room, now(), now());

        /** @var BookingUpdater $updater */
        $updater = $this->app->make(BookingUpdater::class);

        $booking = $updater->update($booking, $room, $startsAt, $endsAt);
